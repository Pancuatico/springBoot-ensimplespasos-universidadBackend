...
public class Aula implements Serializable {
    ...
    private Pabellon pabellon;  //Muchas aulas van a pertenecer a un único pabellón, se hace la relación mucho a uno y se establece la foreign key pabellon_id para nuestra tabla aulas (de este objeto Aula)
